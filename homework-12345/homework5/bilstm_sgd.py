...
info_str,max_len ,embedding_size ,hidden_size ,batch_size,epoch,label_num ,eval_time,learning_rate_SGD,weight_decay =get_param()
info_str='bidr_sgd_'+info_str
num_layers=2
bidirectional=True
if bidirectional:
...
class Classify(nn.Module):
    def __init__(self,vocab_len, embedding_table):
        ...
        self.optim = torch.optim.SGD(self.parameters(),lr=learning_rate_SGD,weight_decay=weight_decay)
